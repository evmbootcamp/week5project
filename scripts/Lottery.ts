...
async function initContracts() {
  ...
  console.log(`Lottery Contract Address: ${contractAddress}`); //0x5fbdb2315678afecb367f032d93f642f64180aa3
  console.log(`Token Address: ${tokenAddress}`); //0xa16E02E87b7454126E5E10d957A927A7F5B5d2be
  /*
  Lottery Contract Address: 0x5fbdb2315678afecb367f032d93f642f64180aa3
